%% GENERATING RANDOM MATRIX AND COMPARING THE RESULTS
% clear;
% clc;
...
%     
%     time_s(i) = s_SVDUrank1(data{i,1},data{i,2},data{i,3}); % stange
%     time(i) = SVDUrank1(data{i,1},data{i,2},data{i,3}); % our
